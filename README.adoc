...
_Kokkidio_'s abstractions reside in the source code only, 
...
Since _Kokkidio_ uses `CMake` for its build configurations, 
debugging flags can be set uniformly for all platforms via the 
...
To cite _Kokkidio_, please use the _IEEE_ article: https://doi.org/10.1109/ACCESS.2025.3635265[10.1109/ACCESS.2025.3635265].

== Licence

_Kokkidio_ is currently being maintained by the
// Chair of Water Resources Management and Modelling of Hydrosystems of the
// Technische Universität Berlin,
// or *wahyd* for short ({wahyd}[Link]).
Chair of Environmental Fluid Dynamics and Modeling (EFDM)
of the
Technische Universität Dresden 
(https://tu-dresden.de/bu/bauingenieurwesen/iwd/efdm[Link]).
Until 2025, it was maintained by the
Chair of Water Resources Management and Modelling of Hydrosystems of the
Technische Universität Berlin 
({wahyd}[Link]).
